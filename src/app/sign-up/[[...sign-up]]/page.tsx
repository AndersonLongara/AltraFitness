...
export default function Page() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-deep-black via-[#0a0a0a] to-deep-black flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute top-[-15%] right-[-10%] w-[600px] h-[600px] bg-acid-lime/10 rounded-full blur-[140px] pointer-events-none animate-pulse" style={{ animationDuration: '5s' }} />
            <div className="absolute bottom-[-15%] left-[-10%] w-[500px] h-[500px] bg-acid-lime/8 rounded-full blur-[120px] pointer-events-none animate-pulse" style={{ animationDuration: '7s', animationDelay: '1s' }} />
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-zinc-500 text-sm font-semibold">
                        Transforme seu negócio fitness com <span className="text-acid-lime font-black">inteligência</span>
                    </p>
                </div>

                {/* Enhanced Clerk Sign-Up Card */}
