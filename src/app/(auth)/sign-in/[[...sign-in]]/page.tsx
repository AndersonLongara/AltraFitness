        ...
        <div className="w-full">
            ...
            <div className="mb-10">
                ...
                <h1 className="text-5xl font-extrabold text-white tracking-tighter leading-[1.1] mb-4">
                    Escale sua <br/>
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2ECC71] to-[#27AE60]">Consultoria.</span>
                </h1>
                
                <p className="text-[#94A3B8] text-lg font-medium leading-relaxed max-w-md">
                    Acesse o painel nº 1 para personal trainers que usam dados para gerar resultados.
                </p>
            </div>
