...
export default function RevenueChart({ data }: RevenueChartProps) {
    return (
        <div className="bg-white dark:bg-pure-white p-8 rounded-[32px] soft-shadow h-full flex flex-col relative overflow-hidden border border-slate-100 dark:border-white/10">
