...
export default function Page() {
    return (
        <div className="min-h-screen bg-deep-black flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute top-[-15%] right-[-10%] w-[500px] h-[500px] bg-acid-lime/10 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute bottom-[-15%] left-[-10%] w-[400px] h-[400px] bg-acid-lime/5 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-zinc-500 mt-2 text-sm font-medium">
                        Comece a transformar seu negócio com o <span className="text-acid-lime font-bold">AltraFit</span>
                    </p>
                </div>
