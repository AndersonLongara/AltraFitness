...
import { Plus, Trash, TextT, ListNumbers, CheckSquare, CaretDown, CaretUp, Calendar, Hash, CheckCircle, DotsSixVertical, At } from "@phosphor-icons/react";
                    ...
                    <div className="bg-white dark:bg-[#1E2A36] p-6 rounded-3xl soft-shadow border border-slate-100 dark:border-white/10">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                type="button"
                                className={`flex-1 px-4 py-3 rounded-xl text-sm font-bold border transition-all ${formType === 'custom'
                            ...
                            <button
                                onClick={() => setFormType('lead_questionnaire')}
                                type="button"
                                className={`flex-1 px-4 py-3 rounded-xl text-sm font-bold border transition-all ${formType === 'lead_questionnaire'
                                    ? 'bg-graphite-dark dark:bg-white text-white dark:text-graphite-dark border-graphite-dark dark:border-white'
                                    : 'bg-white dark:bg-white/5 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-white/20 hover:border-slate-300 dark:hover:border-white/30'
                                    }`}
                            >
