        ...
        <div className="bg-surface-grey border border-white/5 rounded-3xl overflow-hidden">
            ...
            <div className="divide-y divide-white/5">
                ...
                <div className="p-4 px-6">
                    <SignOutButtonSafe className="w-full flex items-center justify-center gap-2 p-3 rounded-xl bg-red-500/10 border border-red-500/20 text-red-500 font-bold hover:bg-red-500 hover:text-white transition-all disabled:opacity-70">
