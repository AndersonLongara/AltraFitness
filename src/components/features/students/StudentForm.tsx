        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-graphite-dark/60 dark:bg-black/60 backdrop-blur-sm p-4 overflow-y-auto">
            <div className="bg-pure-white dark:bg-[#1E2A36] w-full max-w-2xl rounded-3xl soft-shadow overflow-hidden my-auto border border-slate-100 dark:border-white/10">
                ...
                <div className="p-6 border-b border-slate-100 dark:border-white/10 flex justify-between items-center bg-white dark:bg-[#1E2A36] sticky top-0 z-10">
                    ...
                    <button onClick={onClose} className="p-2 text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-white/10 rounded-xl transition-colors">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-xs font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">Nome Completo</label>
                            <input
                                autoFocus
                                type="text"
                                required
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-xs font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">CPF (Obrigatório)</label>
                                <input
                                    type="text"
                                    required
                                    maxLength={14}
                            ...
                            <div>
                                <label className="block text-xs font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">Data de Nascimento</label>
                                <input
                                    type="date"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-xs font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">Gênero</label>
                                <select
                            ...
                            <div>
                                <label className="block text-xs font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">Telefone</label>
                                <input
                                    type="tel"
                        ...
                        <div>
                            <label className="block text-xs font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">Email</label>
                            <input
                                type="email"
                    ...
                    <div className="space-y-4 pt-2">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-xs font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">Altura (cm)</label>
                                <input
                                    type="number"
                                    placeholder="175"
                                    className="w-full p-4 bg-slate-50 dark:bg-white/10 rounded-xl font-medium text-slate-700 dark:text-slate-200 outline-none focus:ring-2 focus:ring-emerald-100 dark:focus:ring-emerald-500/30 placeholder:text-slate-300 dark:placeholder:text-slate-500 border border-transparent dark:border-white/10"
                            ...
                            <div>
                                <label className="block text-xs font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">Peso (kg)</label>
                                <input
                                    type="number"
                                    step="0.1"
                                    placeholder="70.5"
                    ...
                    <div className="space-y-4 pt-2">
                        ...
                        <div>
                            <label className="block text-xs font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">Vencimento do Plano</label>
                            <input
                                type="date"
                                className="w-full p-4 bg-slate-50 dark:bg-white/10 rounded-xl font-medium text-slate-700 dark:text-slate-200 outline-none focus:ring-2 focus:ring-emerald-100 dark:focus:ring-emerald-500/30 text-slate-500 dark:text-slate-300 border border-transparent dark:border-white/10"
                                value={planEnd}
