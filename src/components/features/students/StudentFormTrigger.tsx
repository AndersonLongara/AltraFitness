        ...
        return (
            <>
                <button
                    ...
                    className="p-2 text-slate-400 dark:text-slate-400 hover:text-performance-green dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-white/10 rounded-xl transition-all"
                    title="Editar Aluno"
                >
