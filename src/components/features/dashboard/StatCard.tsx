...
export default function StatCard({ title, value, icon, trend, trendDirection = 'neutral' }: StatCardProps) {
    return (
        <div className="bg-white dark:bg-pure-white p-6 rounded-[32px] soft-shadow flex flex-col justify-between h-full group hover:shadow-lg transition-all duration-300 border border-slate-50 dark:border-white/10">
